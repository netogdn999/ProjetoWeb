...
<jsp:include page="../js/botoesCadastrarProduto.js"></jsp:include>
</script>
...
out.println("<table class=\"visualizarCategoria2\">"+
				...
				out.println("<tr class=\"dados\">"+
								...
								"<td><button class='selecionar' name='"+categoriaB.getId()+"'><a href='jsp/selecionarCategoriaProduto.jsp'><img src='imagens/editar.png'></a></button></td>"+
							"</tr>");
							}
		out.println("</table>"); 
%>
